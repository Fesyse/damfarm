...
export function FishingDialog({
          ...
          setHoldProgress(prev => {
            ...
            if (newProgress >= 100) {
              ...
              if (isMounted) {
                ...
                toast({
                  title: "Успех!",
                  description: `Вы поймали ${
                    FISH_NAME[randomFish.name as keyof typeof FISH_NAME]
                  }!`,
                })
              }
              return 100
  ...
  return (
    <div className='space-y-4 p-4'>
      ...
      {caughtFish && (
        <div
          className={`text-center p-4 rounded-lg space-y-2 border ${
            {
        ...
        >
          <p className='text-lg font-semibold'>
            Поймана рыба: {FISH_NAME[caughtFish.name as keyof typeof FISH_NAME]}
          </p>
          ...
          >
            Редкость: {fishRarity[caughtFish.rarity]}
          </p>
        </div>
      )}
    </div>
